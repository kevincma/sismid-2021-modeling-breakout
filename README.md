...
During the breakout session, download the following files: SISMID_Day_2_Breakout_Overview.pdf walks through the code and contains exercise questions for you to complete in your groups. day-2-heterogeneiety-breakout.Rmd is the Rstudio file with all the code.
